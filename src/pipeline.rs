...
pub struct Pipeline {
    // Bind groups, one for each render/compute stage
...
impl Pipeline {
        ...
        for i in 0..2 {
            particle_bind_groups.push(device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    ...
                    wgpu::BindGroupEntry {
                        binding: 3,
                        resource: agent_buffers[(i + 1) % 2].as_entire_binding(), // bind to opposite buffer
                    },
    ...
    pub fn get_control_alpha(
        &self ) -> f32 {
        self.sim_param_data.control_alpha
    }

    pub fn set_control_alpha(
        &mut self,
        alpha: f32 ) {
        self.sim_param_data.control_alpha = alpha;
        ...
        file_name_prefix: &str)
    {
        ...
        let file_name = format!("{}_{}.png", file_name_prefix, self.sim_param_data.serialize());
        let texture = &self.chemo_textures[0];
    ...
    pub fn compute_step(
        ...
        // render to new_dots_texture
        {
            ...
            command_encoder.push_debug_group("render dot for each agent");
            {
                ...
                rpass.set_vertex_buffer(0, self.agent_buffers[(self.frame_num + 1) % 2].slice(..));
                ...
                rpass.draw(0..6, 0..self.sim_param_data.num_agents);
            ...
            command_encoder.push_debug_group("update agent positions");
            {
                ...
                cpass.dispatch_workgroups(self.sim_param_data.num_agents/64, 1, 1);
            }
            command_encoder.pop_debug_group();
